...
AgentKit supports any LLM provider via LiteLLM using the `provider/model` convention.

## Setup

```bash
pip install 'agentkit[litellm]'
```
...
Install it with: pip install 'agentkit[litellm]'
```
