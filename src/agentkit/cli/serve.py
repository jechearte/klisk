"""agentkit serve — start the production server."""
...
def serve(
    ...
    """Start the AgentKit production server (chat UI + API)."""
    ...
    from agentkit.server.production import create_production_app, run_production_server
