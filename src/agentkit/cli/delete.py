"""agentkit delete — remove an existing project."""
...
def delete(
    ...
    """Delete an AgentKit project directory."""
    ...
    if not config_file.exists():
        typer.echo(f"Error: '{project_path}' does not look like an AgentKit project (no agentkit.config.yaml).", err=True)
        raise typer.Exit(1)
